    ...
    extend: {
      colors: {
        ...
        chromatic: {
          ...
          "coral-soft": "hsl(var(--color-coral-soft))",
          "coral-dark": "hsl(var(--color-coral-dark))",
          blue: "hsl(var(--color-blue))",
          "blue-soft": "hsl(var(--color-blue-soft))",
          "blue-dark": "hsl(var(--color-blue-dark))",
          violet: "hsl(var(--color-violet))",
          "violet-soft": "hsl(var(--color-violet-soft))",
          "violet-dark": "hsl(var(--color-violet-dark))",
          gold: "hsl(var(--color-gold))",
          "gold-soft": "hsl(var(--color-gold-soft))",
          "gold-dark": "hsl(var(--color-gold-dark))",
        },
        // Semantic accent colors (legacy compatibility)
        semantic: {
          lavender: "hsl(var(--color-violet))",
          "lavender-soft": "hsl(var(--color-violet-soft))",
          "lavender-dark": "hsl(var(--color-violet-dark))",
          ...
          "blue-soft": "hsl(var(--color-blue-soft))",
          "blue-dark": "hsl(var(--color-blue-dark))",
          yellow: "hsl(var(--color-gold))",
          "yellow-soft": "hsl(var(--color-gold-soft))",
          "yellow-dark": "hsl(var(--color-gold-dark))",
      ...
      boxShadow: {
        ...
        'glow-coral': '0 0 20px hsla(12, 90%, 60%, 0.3)',
        'glow-violet': '0 0 20px hsla(280, 85%, 55%, 0.3)',
        'glow-blue': '0 0 20px hsla(210, 100%, 55%, 0.3)',
      },
      spacing: {
        '1': 'var(--space-1)',
        '2': 'var(--space-2)',
      ...
      backgroundImage: {
        'gradient-chromatic': 'linear-gradient(135deg, hsl(var(--color-coral)), hsl(var(--color-violet)), hsl(var(--color-blue)))',
        'gradient-warm': 'linear-gradient(135deg, hsl(var(--color-coral)), hsl(var(--color-gold)))',
        'gradient-cool': 'linear-gradient(135deg, hsl(var(--color-violet)), hsl(var(--color-blue)))',
        'gradient-sunset': 'linear-gradient(135deg, hsl(var(--color-coral)), hsl(var(--color-violet)))',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "gradient-flow-slow": "gradient-flow 8s ease infinite",
